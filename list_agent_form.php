              ...
              <form action="" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="AGENT_CODE" placeholder="Enter Agent Code">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="WORKING_AREA" placeholder="Enter Working Area">
                  </div>
                  <div class="form-group">
